(function (window, document) {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const createButtonObject = function (layer) {
            ...
            applyButtonTexture(rect, width, height);
            const label = new fabricLib.Textbox(buttonCanvasLabelText(layer.textRaw), {
                left: 0,
        ...
        const syncLegacyHiddenState = function (scene) {
            ...
            if (buttonLabelInput) {
                const nextButtonLabelValue = buttonLayer ? String(buttonLayer.textRaw || '').trim() : '';
        ...
        const syncButtonInputsToCanvasLayer = function (options) {
            ...
            const requestedLabel = String(buttonLabelInput && buttonLabelInput.value ? buttonLabelInput.value : '').trim();
            ...
            if (!object) {
                if (requestedLabel === '' && requestedHref === '' && opts.createIfMissing !== true) {
                    return false;
                }
