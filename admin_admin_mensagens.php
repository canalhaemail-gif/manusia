...
<?php
$messageSceneRendererAssetUrl = asset_url('assets/js/message-scene-renderer.js');
$messageSceneRendererAssetVersion = @filemtime(BASE_PATH . '/assets/js/message-scene-renderer.js') ?: time();
$adminMessageEditorAssetUrl = asset_url('assets/js/admin-message-editor-v2.js');
$adminMessageEditorAssetVersion = @filemtime(BASE_PATH . '/assets/js/admin-message-editor-v2.js') ?: time();
?>
<script src="<?= e(asset_url('assets/vendor/fabric.min.js')); ?>"></script>
<script src="<?= e($messageSceneRendererAssetUrl . '?v=' . $messageSceneRendererAssetVersion); ?>"></script>
<script src="<?= e($adminMessageEditorAssetUrl . '?v=' . $adminMessageEditorAssetVersion); ?>"></script>
<script>
